...
% *************************************************************************
% 
% PLOT_MATCHES(I1, I2, X, Y, INDEX, CORRECTINDEX) considers correct indexes 
% and indexes reserved by mismatch removal method, and then only plots the 
% ture positive with blue lines, false positive with red lines. For 
% visibility, it plots at most NUMPLOT (Default value is 100) matches.
%   
